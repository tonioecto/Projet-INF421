...
public class Edge { // Les Edges pour l'affichage
	int x1, x2, y1, y2;
	int width;
	public Color color;
	...
	@Override
	public int hashCode() { // On défini un hashCode pour chaque edge, qui est
							// un entier unique.
		return Cantor(this.x1, this.y1, this.x2, this.y2);
	}

	public int Cantor(int x, int y) { // On utilise les polynomes de Cantor pour
										// obtenir une bijection de N^4 dans N
